...
<main>
  ...
  <nav class="grey darken-4" >
    <div class="nav-wrapper">
      <div class="col s12">
        <font size="5" class="hide-on-med-and-down">Listing</font>
...
<input type="hidden" id="baseurl" value="<?php echo base_url(); ?>">
      ...
      <div class="col s12">
        <br>
        <a href="<?php echo site_url() ?>listing/insert" class="btn yellow black-text">Insert Listing</a>
        <br><br>
        ...
        <table class="highlight">
          ...
          <tr>
           <?php foreach ($listing as $list) { ?>
            ...
            class="modal-trigger" href="#modal">
             Update</a>
...
<div id="insidemodal">
  <div class="modal-content">
    ...
    if(!empty($listing)){
      ...
      echo form_open_multipart('listing/update_listing/', $attributes); ?>
  ...
  <div class="input-field col s4">
    <?php echo form_label('UserID Marketing','kodemar');
    $data = array(
      'class'=>'validate',
      'id'=>'kodemar',
      'name'=>'kodemar',
      'value'=> $list->kode_marketing,
      );
    echo form_input($data); echo form_error('kodemar'); ?>
  </div>
...
$('a[name="edit"]').click(function(e) {
    ...
    var listingurl = baseurl + '/listing/selectedlisting/' + this.id;
...
$('#btnUpdate').mouseover(function(event){
  ...
  var kodemar = $('#kodemar').val();
  var namamanager = $('#namamanager').val();

  // var base_url = window.location.href;
  // var listingurl = base_url + '/validate_listing';

  var baseurl = $('#baseurl').val();
  var listingurl = baseurl + 'listing/validate_listing';
